...
const SuggestItineraryInputSchema = z.object({
  interests: z
    .string()
    .describe('A comma-separated list of interests, e.g., beaches, temples, surfing.'),
  travelDates: z
    .string()
    .describe(
  ...
  budget: z
    .string()
    .describe('The budget for the trip, e.g., $1000, €800, or specify a range like $800-$1200.'),
});
