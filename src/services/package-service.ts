...
const packages: Package[] = [
  {
    ...
    price: 750,
    description: 'Immerse yourself in the cultural heart of Bali with temple tours, traditional dance, and local crafts.',
  ...
  },
  {
    ...
    price: 1200,
    description: 'Catch the perfect wave and soak up the sun on Bali\'s most beautiful beaches.',
  ...
  },
  {
    ...
    price: 1500,
    description: 'Indulge in the ultimate luxury with a 5-star resort stay, private spa treatments, and fine dining.',
  ...
  },
  {
    ...
    price: 2500,
    description: 'An all-inclusive adventure featuring volcano treks, scuba diving, and exploration of hidden gems.',
