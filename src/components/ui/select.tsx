...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ...
        className={cn(
            ...
            "rounded-md border-[1px] dark:border-white/50 border-black/60",
            "bg-alternate px-3 py-2 text-sm ring-offset-background",
